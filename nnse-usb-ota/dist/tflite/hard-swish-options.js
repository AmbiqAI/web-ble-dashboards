...
export class HardSwishOptions {
    ...
    static getRootAsHardSwishOptions(bb, obj) {
        return (obj || new HardSwishOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsHardSwishOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new HardSwishOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startHardSwishOptions(builder) {
        builder.startObject(0);
    }
    static endHardSwishOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createHardSwishOptions(builder) {
