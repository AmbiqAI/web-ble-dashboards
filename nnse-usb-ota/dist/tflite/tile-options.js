...
export class TileOptions {
    ...
    static getRootAsTileOptions(bb, obj) {
        return (obj || new TileOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsTileOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new TileOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startTileOptions(builder) {
        builder.startObject(0);
    }
    static endTileOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createTileOptions(builder) {
