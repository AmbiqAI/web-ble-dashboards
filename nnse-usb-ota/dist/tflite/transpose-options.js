...
export class TransposeOptions {
    ...
    static getRootAsTransposeOptions(bb, obj) {
        return (obj || new TransposeOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsTransposeOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new TransposeOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startTransposeOptions(builder) {
        builder.startObject(0);
    }
    static endTransposeOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createTransposeOptions(builder) {
