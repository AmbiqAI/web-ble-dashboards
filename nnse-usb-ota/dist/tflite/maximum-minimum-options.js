...
export class MaximumMinimumOptions {
    ...
    static getRootAsMaximumMinimumOptions(bb, obj) {
        return (obj || new MaximumMinimumOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsMaximumMinimumOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new MaximumMinimumOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startMaximumMinimumOptions(builder) {
        builder.startObject(0);
    }
    static endMaximumMinimumOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createMaximumMinimumOptions(builder) {
