...
export class AbsOptions {
    ...
    static getRootAsAbsOptions(bb, obj) {
        return (obj || new AbsOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsAbsOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new AbsOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startAbsOptions(builder) {
        builder.startObject(0);
    }
    static endAbsOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createAbsOptions(builder) {
