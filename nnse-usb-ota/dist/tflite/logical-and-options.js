...
export class LogicalAndOptions {
    ...
    static getRootAsLogicalAndOptions(bb, obj) {
        return (obj || new LogicalAndOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsLogicalAndOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new LogicalAndOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startLogicalAndOptions(builder) {
        builder.startObject(0);
    }
    static endLogicalAndOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createLogicalAndOptions(builder) {
