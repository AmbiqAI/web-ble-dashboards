...
export class ZerosLikeOptions {
    ...
    static getRootAsZerosLikeOptions(bb, obj) {
        return (obj || new ZerosLikeOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsZerosLikeOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new ZerosLikeOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startZerosLikeOptions(builder) {
        builder.startObject(0);
    }
    static endZerosLikeOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createZerosLikeOptions(builder) {
