...
export class MirrorPadOptions {
    ...
    static getRootAsMirrorPadOptions(bb, obj) {
        return (obj || new MirrorPadOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsMirrorPadOptions(bb, obj) {
    ...
    static startMirrorPadOptions(builder) {
        builder.startObject(1);
    }
    static addMode(builder, mode) {
        builder.addFieldInt8(0, mode, MirrorPadMode.REFLECT);
    }
    static endMirrorPadOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createMirrorPadOptions(builder, mode) {
