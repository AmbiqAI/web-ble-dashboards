...
export class HashtableFindOptions {
    ...
    static getRootAsHashtableFindOptions(bb, obj) {
        return (obj || new HashtableFindOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsHashtableFindOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new HashtableFindOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startHashtableFindOptions(builder) {
        builder.startObject(0);
    }
    static endHashtableFindOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createHashtableFindOptions(builder) {
