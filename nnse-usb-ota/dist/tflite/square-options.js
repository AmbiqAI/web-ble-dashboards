...
export class SquareOptions {
    ...
    static getRootAsSquareOptions(bb, obj) {
        return (obj || new SquareOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsSquareOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new SquareOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startSquareOptions(builder) {
        builder.startObject(0);
    }
    static endSquareOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createSquareOptions(builder) {
