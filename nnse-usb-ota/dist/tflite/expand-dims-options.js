...
export class ExpandDimsOptions {
    ...
    static getRootAsExpandDimsOptions(bb, obj) {
        return (obj || new ExpandDimsOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsExpandDimsOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new ExpandDimsOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startExpandDimsOptions(builder) {
        builder.startObject(0);
    }
    static endExpandDimsOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createExpandDimsOptions(builder) {
