...
export class AddNOptions {
    ...
    static getRootAsAddNOptions(bb, obj) {
        return (obj || new AddNOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsAddNOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new AddNOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startAddNOptions(builder) {
        builder.startObject(0);
    }
    static endAddNOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createAddNOptions(builder) {
