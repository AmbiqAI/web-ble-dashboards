...
export class GreaterOptions {
    ...
    static getRootAsGreaterOptions(bb, obj) {
        return (obj || new GreaterOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsGreaterOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new GreaterOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startGreaterOptions(builder) {
        builder.startObject(0);
    }
    static endGreaterOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createGreaterOptions(builder) {
