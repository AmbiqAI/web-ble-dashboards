...
export class LogicalNotOptions {
    ...
    static getRootAsLogicalNotOptions(bb, obj) {
        return (obj || new LogicalNotOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsLogicalNotOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new LogicalNotOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startLogicalNotOptions(builder) {
        builder.startObject(0);
    }
    static endLogicalNotOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createLogicalNotOptions(builder) {
