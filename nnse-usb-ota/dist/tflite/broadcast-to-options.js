...
export class BroadcastToOptions {
    ...
    static getRootAsBroadcastToOptions(bb, obj) {
        return (obj || new BroadcastToOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsBroadcastToOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new BroadcastToOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startBroadcastToOptions(builder) {
        builder.startObject(0);
    }
    static endBroadcastToOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createBroadcastToOptions(builder) {
