...
export class Uint8Vector {
    ...
    static getRootAsUint8Vector(bb, obj) {
        return (obj || new Uint8Vector()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsUint8Vector(bb, obj) {
    ...
    static startUint8Vector(builder) {
    ...
    static endUint8Vector(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createUint8Vector(builder, valuesOffset) {
