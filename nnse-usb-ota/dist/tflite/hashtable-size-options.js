...
export class HashtableSizeOptions {
    ...
    static getRootAsHashtableSizeOptions(bb, obj) {
        return (obj || new HashtableSizeOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsHashtableSizeOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new HashtableSizeOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startHashtableSizeOptions(builder) {
        builder.startObject(0);
    }
    static endHashtableSizeOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createHashtableSizeOptions(builder) {
