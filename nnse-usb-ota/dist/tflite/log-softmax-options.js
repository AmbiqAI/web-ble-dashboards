...
export class LogSoftmaxOptions {
    ...
    static getRootAsLogSoftmaxOptions(bb, obj) {
        return (obj || new LogSoftmaxOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsLogSoftmaxOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new LogSoftmaxOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startLogSoftmaxOptions(builder) {
        builder.startObject(0);
    }
    static endLogSoftmaxOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createLogSoftmaxOptions(builder) {
