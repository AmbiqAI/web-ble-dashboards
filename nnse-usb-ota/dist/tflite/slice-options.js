...
export class SliceOptions {
    ...
    static getRootAsSliceOptions(bb, obj) {
        return (obj || new SliceOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsSliceOptions(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new SliceOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startSliceOptions(builder) {
        builder.startObject(0);
    }
    static endSliceOptions(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createSliceOptions(builder) {
